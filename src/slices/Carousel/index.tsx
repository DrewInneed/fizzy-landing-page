...
const Carousel = ({ slice }: CarouselProps): JSX.Element => {
  ...
  const changeIndex = (index: number) => {
    ...
    spinTl
      ...
      // * trick to run a function before animation
      // * to avoid flickering when change to new can
  ...
  return (
    <Bounded
      ...
      className="carousel relative grid h-screen grid-rows-[auto,4fr,auto] justify-center overflow-hidden bg-white p-12 text-white"
    >
      ...
      <div className="grid grid-cols-[auto,auto,auto] items-center">
        {/* left */}
        <ArrowButton
          onClick={() => changeIndex(currentFlavorIndex + 1)}
          label="left"
          direction="left"
        />
        {/* center */}
